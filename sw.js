...
const CACHE_NAME='thor-loterias-2026-09-13-combinacoes-3d-59';
const CORE=['./','./index.html','./app-main.html','./analysis-neon.css','./fechamento-personalizado-luxo.css','./filtros-auto.js','./combinacoes-3d.css','./combinacoes-3d.js','./home-banner.css','./manifest.json','./icon-192.png','./icon-512.png','./icon-512-maskable.png'];
