// THOR 7 V110 - Botao COLAR para preencher a grade de dezenas. Login e trava nao sao alterados.
(function(){'use strict';
...
function montar(){
  ...
  btn.onclick=async function(){
    ...
    // Limpa selecoes atuais usando o botao LIMPAR da propria tela, quando existir.
    const limpar=[...card.querySelectorAll('button')].find(e=>/limpar/i.test(e.textContent||''));if(limpar)limpar.click();
