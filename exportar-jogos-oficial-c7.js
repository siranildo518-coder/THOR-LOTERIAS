(function(){
  ...
  function montar(){
    ...
    menu.innerHTML='<button type="button" id="thorCopiarJogosC7" style="width:100%;padding:13px 10px;border:0;background:transparent;color:#fff;text-align:center;font:700 12px Arial,sans-serif;">▣ Copiar jogos</button>';
    ...
    menu.querySelector('#thorCopiarJogosC7').addEventListener('click',copiarJogos);
